...
return (
  <>
    <section className="py-8 my-8  bg-white md:py-16 dark:bg-gray-900 antialiased">
        <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
            <div className="shrink-0 max-w-md lg:max-w-lg mx-auto">
              <img className="w-full dark:hidden" src={input.image_url} alt="" />
            </div>
    ...
    <section  className="bg-white py-4 my-28 antialiased dark:bg-gray-900 md:py-4">
